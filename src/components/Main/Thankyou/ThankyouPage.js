...
const ThankYouPage = () => {
    ...
    const orderData = useSelector(state => state.busReducers.busBookingList[0])
    ...
    return (
        <section className="container">
            ...
            <div className="col-12 col-sm-12 col-md-8 col-lg-6 mx-auto shadow-sm p-5 mt-5">
                ...
                <h6><small>Your Bus Name:</small> <small className="text-primary">{orderData?.name}</small></h6>
                <h6><small>Your Paid: </small> <strong className="text-primary"> $790 </strong></h6>
